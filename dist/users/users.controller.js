...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'professor account creation' }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'get all users data.  only for role admin' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'getting the user data' }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('/:id'),
